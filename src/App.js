...
function App() {
  ...
  const [cardArray, setCardArray] = useState([{"text" : "Enter text", "likes" : 0, "dislikes" : 0}]);
      ...
      <div className="RetroApp row">
        ...
        <div className="RetroCategory RetroCategory-1">
          ...
          <button type="button" className="ButtonAdd button button-default" aria-label="Add new card"
            title="Add new card" onClick={() => {setCardArray(cardArray.concat({"text":"Enter text", "likes" : 0, "dislikes" : 0}));
